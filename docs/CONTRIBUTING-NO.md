# Bidrag til ShopRemote2

ShopRemote2 er åpene for bidrag fra alle. Her er reglene for de som har lyst til å
hjelpe oss:

## Bidrag

Bidrag til ShopRemote2 eller deres avhengigheter burde være i form av GitHub pull requests.
...
ShopRemote2 bidragere burker [Discord](https://discord.gg/nDceKgxnkV).
