...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til ShopRemote2-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan ShopRemote2 ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere ShopRemote2 på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give ShopRemote2 \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give ShopRemote2 \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give ShopRemote2 mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [ShopRemote2 Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep ShopRemote2 background service", "Behold ShopRemote2 baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn ShopRemote2 appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show ShopRemote2", "Vis ShopRemote2"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af ShopRemote2 er nødvendigt."),
        ...
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give ShopRemote2 rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af ShopRemote2."),
        ...
        ("verify_shopremote2_password_tip", "Bekræft ShopRemote2 adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge ShopRemote2 til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Opgradér venligst ShopRemote2 Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre ShopRemote2 i at køre normalt."),
        ...
        ("powered_by_me", "Drives af ShopRemote2"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af ShopRemote2 med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis ShopRemote2 vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at ShopRemote2 baggrundstjenesten kører"),
        ...
        ("About ShopRemote2", "Om ShopRemote2"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Opgrader venligst ShopRemote2-klienten til version {} eller nyere på fjernsiden!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
