...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete ShopRemote2..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), ShopRemote2 potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare ShopRemote2 a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a ShopRemote2 il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a ShopRemote2 il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a ShopRemote2 di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [ShopRemote2 Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep ShopRemote2 background service", "Mantieni il servizio di ShopRemote2 in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione ShopRemote2, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show ShopRemote2", "Visualizza ShopRemote2"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a ShopRemote2 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a ShopRemote2."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di ShopRemote2."),
        ...
        ("verify_shopremote2_password_tip", "Conferma password ShopRemote2"),
        ...
        ("Exit", "Esci da ShopRemote2"),
        ("Open", "Apri ShopRemote2"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare ShopRemote2 e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Aggiorna ShopRemote2 Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di ShopRemote2 come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da ShopRemote2"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra ShopRemote2 è aperta"),
        ...
        ("About ShopRemote2", "Info su ShopRemote2"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Aggiorna il client ShopRemote2 remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, ShopRemote2 verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, ShopRemote2 salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, ShopRemote2 non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server ShopRemote2 non include questa funzionalità."),
