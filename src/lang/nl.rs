...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het ShopRemote2 netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer ShopRemote2 op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u ShopRemote2 toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u ShopRemote2 toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u ShopRemote2 toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [ShopRemote2 Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep ShopRemote2 background service", "ShopRemote2 achtergronddienst behouden"),
        ...
        ("Show ShopRemote2", "Toon ShopRemote2"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u ShopRemote2 toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u ShopRemote2 toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende ShopRemote2."),
        ...
        ("verify_shopremote2_password_tip", "Bevestiging wachtwoord ShopRemote2"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om ShopRemote2 te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Upgrade ShopRemote2 Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor ShopRemote2 mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het ShopRemote2-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt ShopRemote2 op de achtergrond actief te houden"),
        ...
        ("About ShopRemote2", "Over ShopRemote2"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Upgrade de ShopRemote2 client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert ShopRemote2 het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat ShopRemote2 verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt ShopRemote2 niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de ShopRemote2-server."),
